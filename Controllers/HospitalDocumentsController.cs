...
namespace TicketManagementApi.Controllers
{
    ...
    [ApiController]
    public class HospitalDocumentsController : Controller
    {
        /// <summary>
        /// CRUD for Hospital Document
        /// </summary>
        /// <param name="bl"></param>        
        /// <returns></returns>
        [HttpPost("crdhospitaldocument")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public async Task<ReturnClass.ReturnString> CUDOperation([FromBody] BlHospitalDocuments bl)
        {
            DlHospitalDocuments dl = new();
