...
namespace HospitalManagementStoreApi.Models.Balayer
{
    ...
    public class LoginTrail
    {
        ...
        public int siteAccessMode { get; set; }
        public int isLoginSuccessful { get; set; }
        ...
        public void SetAccessMode()
        {
            ...
            {
                // "You are using a Mobile device. " + device_info;
                siteAccessMode = 2;
            }
            else
            {
